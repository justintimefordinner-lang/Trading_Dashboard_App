  ...
  return (
    <main className="px-4">
      <ShowAmounts>
        ...
        <StocksView equities={equities} closed={closed} initialStatus={view === "closed" ? "closed" : "open"} closedMode={closedMode} closedMonths={closedMonths} laddersNextAt={snap.meta.coveredCallsNextAt ?? undefined} />
